...
#ifndef CHARACTER_STATES
#define CHARACTER_STATES
#include "State.h"

class Character;
class NotInteracting:public State<Character>
{
private:
	NotInteracting(){}
	NotInteracting& operator = (const NotInteracting&);
public:
	static NotInteracting* Instance();
	void Enter(Character *io);
	void Execute(Character *io);
	void Exit(Character *io);
};

class Interacting:public State<Character>
{
private:
	Interacting(){}
	Interacting& operator = (const Interacting&);
public:
